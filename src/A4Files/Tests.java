...
//		FileSystemObject f1 = new FileSystemObject("C:", 0);
//		
//		FileSystemObject f2 = new FileSystemObject("Jhon Doe", 1);
//		FileSystemObject f5 = new FileSystemObject("Documents", 11);
//		FileSystemObject f6 = new FileSystemObject("Videos", 12);
//		ComputerFile f7 = new ComputerFile("A4.java", 13, 10);
//		
//		FileSystemObject f3 = new FileSystemObject("Public", 2);
//		
//		FileSystemObject f4 = new FileSystemObject("Sam Doe", 3);
//		ComputerFile f8 = new ComputerFile("img1jpg", 31, 10);
//		ComputerFile f9 = new ComputerFile("img2jpg", 32, 10);
//		ComputerFile f10 = new ComputerFile("img3jpg", 33, 10);
//		ComputerFile f11 = new ComputerFile("img4jpg", 34, 10);
//		
//		f1.addChild(f2);
//		f1.addChild(f3);
//		f1.addChild(f4);
...
//		f4.addChild(f8);
//		
//		DirectoryTree tree = new DirectoryTree(f1);
//		
//		System.out.println(tree);
//		System.out.println(f2);
//		System.out.println(f11);
//		System.out.println(tree.lca(f2, f11));
